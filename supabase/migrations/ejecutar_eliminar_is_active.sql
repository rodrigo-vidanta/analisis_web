...
-- (pueden existir con diferentes firmas)
...
DROP FUNCTION IF EXISTS update_coordinacion_safe(p_id UUID, p_codigo TEXT, p_nombre TEXT, p_descripcion TEXT, p_archivado BOOLEAN, p_is_operativo BOOLEAN);
DROP FUNCTION IF EXISTS public.update_coordinacion_safe;
