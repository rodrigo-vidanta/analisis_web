-- SCRIPT DE ACTUALIZACIÓN COMPLETO (ejecutar en Supabase SQL Editor)
...
-- PASO 2: Crear función con etapa_id
...
SELECT etapa_id FROM get_dashboard_conversations(NULL, TRUE, NULL, NULL, 1, 0) LIMIT 1;
