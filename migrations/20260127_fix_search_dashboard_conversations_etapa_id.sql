-- ============================================
-- FIX: Agregar etapa_id a funciones RPC de conversaciones
-- ============================================
-- Fecha: 27 Enero 2026
-- Problema: search_dashboard_conversations devuelve etapa (string legacy) pero NO etapa_id
-- Causa: EtapaBadge muestra "? Sin etapa" porque etapa_id es NULL
-- Solución: Agregar etapa_id a los RETURNS TABLE de ambas funciones
-- ============================================

-- ============================================
-- FUNCIÓN 1: search_dashboard_conversations
-- ============================================
...
-- ============================================
-- VERIFICACIÓN: Buscar un prospecto
-- ============================================
