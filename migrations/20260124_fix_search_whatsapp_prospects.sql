-- ============================================
-- CORRECCIÓN: Función con nombre de columna correcto
-- ============================================
...
AS $$
  ...
  FROM prospectos p
  WHERE 
    -- Debe tener mensajes (usando fecha_hora)
...
-- ============================================
-- PRUEBA: Debería encontrar a Rosario ahora
-- ============================================
...
SELECT 
  ...
  whatsapp,
  email
FROM search_whatsapp_prospects('Rosario', TRUE, 50);
