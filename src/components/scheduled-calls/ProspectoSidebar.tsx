...
export const ProspectoSidebar: React.FC<ProspectoSidebarProps> = ({ prospectoId, isOpen, onClose, onNavigateToLiveChat }) => {
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-3/5 bg-white dark:bg-gray-900 shadow-2xl z-[70] flex items-center justify-center"
          >
