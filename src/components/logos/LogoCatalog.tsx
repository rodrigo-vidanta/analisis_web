...
export const LOGO_CATALOG: Record<LogoType, LogoConfig> = {
  ...
  christmas: {
    ...
    preview: '/assets/pqnc-christmas-text-final.webp',
  ...
  newyear: {
    ...
    preview: '/assets/logo_pqnc-newyear.webp',
  ...
  reyes: {
    ...
    preview: '/assets/logo_pqnc-reyes.webp',
    component: ReyesLogo,
  ...
  valentine: {
    ...
    preview: '/assets/logo_pqnc-valentine.webp',
