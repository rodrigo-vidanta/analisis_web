          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl border border-gray-200 dark:border-gray-700 p-3">
                  ...
                  <div key={color} className="flex flex-col items-center gap-1">
                    <button
                      ...
                      className={`w-8 h-8 rounded-full flex items-center justify-center transition-all duration-200 ${
                        ...
                        isSelected ? 'ring-2 ring-gray-900 dark:ring-gray-100 scale-110' : 'opacity-70 hover:opacity-100'
                      }`}
            ...
            <div className="border-t border-gray-200 dark:border-gray-600 pt-2">
              <button
                ...
                className={`w-full px-3 py-1 text-center hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors flex items-center justify-center gap-2 rounded ${
                  !selectedColor ? 'bg-gray-100 dark:bg-gray-700' : ''
                }`}
