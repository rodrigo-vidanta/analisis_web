...
const LiveMonitorKanban: React.FC = () => {
  ...
  useEffect(() => {
    const handleWidgetTransfer = async (event: CustomEvent<{ callId: string }>) => {
      ...
      if (call) {
        // Seleccionar la llamada y abrir el modal de transferencia
        setSelectedCall(call);
        
        // Pequeño delay para asegurar que selectedCall se actualice
        setTimeout(async () => {
        ...
        // Si no está en llamadas activas, intentar buscar en todas
