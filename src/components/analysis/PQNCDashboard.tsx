...
const PQNCDashboard: React.FC = () => {
  ...
  // SORTING: Aplicar ordenamiento antes de la paginación
  const sortedCalls = applySorting(topFilteredCalls);
            ...
            <div className="overflow-x-auto" style={{ overflow: 'visible' }}>
              <table className="w-full" style={{ position: 'relative' }}>
                <thead className="bg-slate-50 dark:bg-slate-700">
                  <tr>
                    <SortableHeader field="agent_name">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <SortableHeader field="call_result">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      Resultado
                    </SortableHeader>
                    <SortableHeader field="quality_score">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
