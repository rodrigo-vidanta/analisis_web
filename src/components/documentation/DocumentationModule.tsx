...
const gitCommits: GitCommit[] = [
  { hash: 'pending', date: '2026-01-29', author: 'Team', message: 'v2.5.62: B10.1.43N2.5.62 - HOTFIX: Fix error scope prospectosFiltrados - módulo de p...', isRelease: true },
...
const stats = [
  { label: 'Version', value: 'v2.5.62', highlight: true },
  { label: 'Release', value: 'B10.1.43N2.5.62', highlight: false },
