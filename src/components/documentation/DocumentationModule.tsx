...
const gitCommits: GitCommit[] = [
  ...
  { hash: '4980092', date: '2026-03-11', author: 'Team', message: 'v2.31.5: B10.3.0N2.31.5 - Deploy automatico', isRelease: true },
  { hash: '453fe6d', date: '2026-03-11', author: 'Team', message: 'v2.31.4: B10.3.0N2.31.4 - Deploy automatico', isRelease: true },
  { hash: 'ee79cc0', date: '2026-03-11', author: 'Team', message: 'v2.31.3: B10.3.0N2.31.3 - Deploy automatico', isRelease: true },
  { hash: '5423944', date: '2026-03-11', author: 'Team', message: 'v2.31.2: B10.3.0N2.31.2 - 1 fix', isRelease: true },
  { hash: '73ed75e', date: '2026-03-11', author: 'Team', message: 'v2.31.1: B10.3.0N2.31.1 - 2', isRelease: true },
  ...
  { hash: '2b95e4b', date: '2026-02-18', author: 'Team', message: 'v2.17.1: B10.1.44N2.17.1 - fix crash forwardRef en vendor-audio chunk 2', isRelease: true },
  ...
  { hash: '37f52f9', date: '2026-02-11', author: 'Team', message: 'v2.12.2: B10.1.44N2.12.2 - 1 fix + Sesión anterior (CPU Optimization Fase 3)', isRelease: true },
  ...
  { hash: 'bbd6b31', date: '2026-02-11', author: 'Team', message: 'v2.10.2: B10.1.44N2.10.2 - Rediseño del modal de reactivación de conversación + Sesion con dos bloques: ...', isRelease: true },
  ...
  { hash: '0177a49', date: '2026-01-29', author: 'Team', message: 'v2.5.60: B10.1.43N2.5.60 - FIX CRÍTICO: uchat_id string vacío impide pausar bot y en...', isRelease: true },
...
const awsDeployments: AWSDeployment[] = [
  ...
  { id: 'deploy-379', date: '11/03/2026, 12:39', version: 'B10.3.0N2.31.5', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  { id: 'deploy-942', date: '11/03/2026, 12:03', version: 'B10.3.0N2.31.4', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  { id: 'deploy-503', date: '11/03/2026, 11:20', version: 'B10.3.0N2.31.3', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  { id: 'deploy-901', date: '11/03/2026, 10:26', version: 'B10.3.0N2.31.2', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  { id: 'deploy-729', date: '11/03/2026, 10:19', version: 'B10.3.0N2.31.1', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-779', date: '18/02/2026, 16:31', version: 'B10.1.44N2.17.1', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-035', date: '11/02/2026, 17:53', version: 'B10.1.44N2.12.2', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-143', date: '10/02/2026, 18:02', version: 'B10.1.44N2.10.2', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-354', date: '29/01/2026, 17:29', version: 'B10.1.43N2.5.67', status: 'success', duration: '25s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-122', date: '2026-01-20 22:30', version: 'B10.1.19N2.5.19', status: 'success', duration: '19s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
  ...
  { id: 'deploy-112', date: '2026-01-18 12:05', version: 'B10.1.9N2.5.9', status: 'success', duration: '17s', triggeredBy: 'Samuel Rosales', environment: 'Production' },
...
const stats = [
  { label: 'Version', value: 'v2.31.13', highlight: true },
  { label: 'Release', value: 'B10.3.0N2.31.13', highlight: false },
