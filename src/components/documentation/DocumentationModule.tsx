...
const gitCommits: GitCommit[] = [
  { hash: 'pending', date: '2026-01-28', author: 'Team', message: 'v2.5.52: B10.1.43N2.5.52 - Fix filtros de etapa en WhatsApp - Migración a etapas din...', isRelease: true },
...
const stats = [
  { label: 'Version', value: 'v2.5.52', highlight: true },
  { label: 'Release', value: 'B10.1.43N2.5.52', highlight: false },
