...
const gitCommits: GitCommit[] = [
  { hash: 'pending', date: '2026-01-30', author: 'Team', message: 'v2.5.72: B10.1.44N2.5.72 - Sistema de Heartbeat completo + Indicador usuario en líne...', isRelease: true },
...
const stats = [
  { label: 'Version', value: 'v2.5.72', highlight: true },
  { label: 'Release', value: 'B10.1.44N2.5.72', highlight: false },
