...
const LiveChatFixed: React.FC = () => {
  ...
  const [resizeStartWidths, setResizeStartWidths] = useState(columnWidths);
  ...
  // ============================================
  // MANEJO DE REDIMENSIONAMIENTO CORREGIDO
  // ============================================
  ...
  const scrollToBlock = (block: ConversationBlock) => {
    ...
    // Encontrar el primer mensaje del bloque y hacer scroll
  ...
  // ============================================
  // RENDERIZADO DE MENSAJES CON MARKDOWN MEJORADO
  // ============================================
        ...
        <div className={`flex mb-4 ${isCustomer ? 'justify-start' : 'justify-end'}`}>
          <div className={`max-w-xs lg:max-w-md ${isCustomer ? 'order-2 ml-3' : 'order-1 mr-3'}`}>
            ...
            <div className={`relative px-4 py-2 rounded-2xl ${
              ...
              {/* Contenido con Markdown y saltos de línea */}
              {message.content && (
  ...
  return (
    <div className="flex bg-white overflow-hidden" style={{ 
      height: '100%', // Usar toda la altura disponible del contenedor padre
      ...
      >
        ...
        <div 
          ...
          style={{ height: 'calc(100% - 200px)', overscrollBehavior: 'contain' }}
        >
      ...
      {selectedConversation && (
        <>
          ...
          >
            ...
            {/* Lista de bloques con scroll independiente */}
            <div 
              ref={blocksScrollRef}
              className="flex-1 overflow-y-auto overscroll-none"
              style={{ height: 'calc(100% - 120px)', overscrollBehavior: 'contain' }}
            >
      ...
      {selectedConversation ? (
        ...
        >
          ...
          {/* Input de mensaje FIJO en la parte inferior de la columna */}
        ...
        <div 
          className="flex items-center justify-center text-slate-500 bg-white"
