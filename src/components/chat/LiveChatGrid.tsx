...
const LiveChatGrid: React.FC = () => {
  ...
  // ============================================
  // RENDERIZADO PRINCIPAL - CSS GRID SIMPLE
  // ============================================
  ...
  return (
    <div 
      ...
      style={{ 
        height: '100%',
        gridTemplateColumns: selectedConversation ? '300px 250px 1fr' : '300px 1fr',
    ...
    >
      ...
      {/* Columna 2: Bloques de Conversación */}
      {selectedConversation && (
        <div className="border-r border-slate-200 flex flex-col bg-white">
          <div className="p-4 border-b border-slate-100 bg-white flex-shrink-0">
      ...
      {selectedConversation ? (
        ...
        <div className="flex items-center justify-center text-slate-500 bg-white">
          <div className="text-center">
