...
const TemplateManager: React.FC<TemplateManagerProps> = ({ onClose, isModal = true }) => {
          ...
          <div key={prompt.id} className="glass-card p-6 group hover:shadow-lg transition-all">
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <button className="p-2 text-gray-400 hover:text-green-500 transition-colors" title="Duplicar">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const mainContent = (
    <div className={`bg-white dark:bg-gray-900 ${isModal ? 'rounded-lg' : ''} w-full ${isModal ? 'max-w-7xl h-[90vh]' : 'min-h-screen'} flex flex-col`}>
        {/* Header */}
