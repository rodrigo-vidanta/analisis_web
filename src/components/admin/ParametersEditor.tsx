  ...
  return (
    <div className="glass-card">
      <div className="grid grid-cols-1 lg:grid-cols-4 min-h-[480px]">
        {/* Nav lateral */}
        <div className="lg:col-span-1 border-r border-gray-200 dark:border-gray-700 p-6 space-y-2">
          {[
            ...
            <button key={s.id} onClick={()=>setActiveSection(s.id)} className={`w-full text-left px-4 py-3 rounded-lg transition ${activeSection===s.id? 'bg-gradient-to-r from-purple-500/10 to-indigo-500/10 border border-purple-200 dark:border-purple-500 text-purple-700 dark:text-purple-300':'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700'}` }>
        ...
        {activeSection==='identity' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Identidad del Agente</h4>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-white"
            />
          </div>
        ...
        {activeSection==='model' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Modelo de IA</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
        ...
        {activeSection==='voice' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Voz</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Proveedor</label>
                <select
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Voice ID</label>
                <input className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-800 dark:text-white" value={currentParams.voice?.voiceId || 'default'} onChange={(e)=>updateParameter('voice','voiceId',e.target.value)} />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSection==='transcriber' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Transcripción</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Proveedor</label>
                <select className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-800 dark:text-white" value={currentParams.transcriber?.provider || 'deepgram'} onChange={(e)=>updateParameter('transcriber','provider',e.target.value)}>
                  <option value="deepgram">Deepgram</option>
                </select>
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Modelo</label>
                <input className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-800 dark:text-white" value={currentParams.transcriber?.model || 'nova-3'} onChange={(e)=>updateParameter('transcriber','model',e.target.value)} />
              </div>
            </div>
          </div>
        )}
        ...
        {activeSection==='behavior' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Comportamiento</h4>
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <select
                  ...
                  className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-white"
                >
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  className="w-24 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 dark:bg-gray-800 dark:text-white"
                />
              </div>
            </div>
          </div>
        ...
        {activeSection==='call' && (
          <div className="glass-card p-6">
            <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">Llamada</h4>
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Mensaje de fin de llamada (End Call)</label>
                <textarea
                  rows={2}
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-amber-300 dark:border-amber-600 rounded-lg focus:ring-2 focus:ring-amber-500 bg-white dark:bg-gray-800 dark:text-white"
              >
            ...
            {squadConfig.transferType === 'phone' && (
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-amber-300 dark:border-amber-600 rounded-lg focus:ring-2 focus:ring-amber-500 dark:bg-gray-800 dark:text-white"
                />
              </div>
            )}
