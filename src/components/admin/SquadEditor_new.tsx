...
const SquadEditor: React.FC<SquadEditorProps> = ({
  ...
  const loadMemberPrompts = async () => {
    ...
    for (const member of squadMembers) {
      if (member.originalMessages && member.originalMessages.length > 0) {
        ...
        // Por ahora, usar prompts vacíos - se puede expandir después
        prompts[member.id] = [];
      } else {
        prompts[member.id] = [];
      }
                ...
                <div className="space-y-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                      {squadMembers.filter((_, index) => index > 0).map((member, index) => {
                  ...
                  {!selectedMemberForRoles && squadMembers.length > 1 && (
                    <div className="text-center py-12">
