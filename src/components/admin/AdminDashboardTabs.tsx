...
type AdminTab = 'usuarios' | 'preferencias' | 'configuracion-db' | 'tokens' | 'api-tokens' | 'ejecutivos' | 'coordinaciones' | 'plantillas-uchat';
...
const AdminDashboardTabs: React.FC = () => {
  ...
  const tabs = [
    ...
    ...(isAdmin ? [
      ...
      {
        id: 'plantillas-uchat' as AdminTab,
        name: 'Plantillas uChat',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex-1 overflow-y-auto bg-gray-50 dark:bg-gray-900">
            <div className="w-full max-w-[98%] 2xl:max-w-[96%] mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-10 py-6 lg:py-8">
              <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
                ...
                {activeTab === 'plantillas-uchat' && isAdmin && (
                  <div className="p-4 sm:p-5 md:p-6 lg:p-8">
