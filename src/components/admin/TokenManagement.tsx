  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-16">
        ...
        <span className="ml-3 text-sm text-gray-500 dark:text-gray-400">Cargando tokens...</span>
      </div>
    );
  }
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700/50">
                  ...
                  <motion.button
                    ...
                    disabled={saving === userConfig.user_id}
                    className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-gray-700 dark:bg-gray-600 rounded-xl hover:bg-gray-600 dark:hover:bg-gray-500 disabled:opacity-50 transition-all"
                  >
