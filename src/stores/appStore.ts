...
type AppMode = 'natalia' | 'pqnc' | 'live-monitor' | 'admin' | 'ai-models' | 'live-chat' | 'prospectos' | 'scheduled-calls' | 'direccion' | 'analisis' | 'operative-dashboard' | 'campaigns' | 'dashboard';
